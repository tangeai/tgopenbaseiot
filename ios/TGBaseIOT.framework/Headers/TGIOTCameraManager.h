...
@property (nonatomic, strong, nullable) dispatch_semaphore_t sendCmdSemphore;
@property (nonatomic, strong, nullable) dispatch_semaphore_t playLiveChannelZeroVideoSemphore;
@property (nonatomic, strong, nullable) dispatch_semaphore_t playLiveChannelOneVideoSemphore;
@property (nonatomic, strong, nullable) dispatch_semaphore_t playLiveAudioSemphore;

@property (nonatomic, strong, nullable) dispatch_semaphore_t playSDCardChannelZeroVideoSemphore;
@property (nonatomic, strong, nullable) dispatch_semaphore_t playSDCardChannelOneVideoSemphore;
@property (nonatomic, strong, nullable) dispatch_semaphore_t playSDCardAudioSemphore;

@property (nonatomic, strong, nullable) dispatch_semaphore_t readLiveChannelZeroVideoSemphore;
@property (nonatomic, strong, nullable) dispatch_semaphore_t readLiveChannelOneVideoSemphore;
@property (nonatomic, strong, nullable) dispatch_semaphore_t readLiveAudioSemphore;
